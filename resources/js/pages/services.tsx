...
import ServicesView from '@/components/status/views/ServicesView';
import type { PublicPageProps } from '@/types/status';

export default function ServicesPage({ meta, frame, snapshot, user }: PublicPageProps) {
    return (
        <>
            ...
            >
                <ServicesView snapshot={snapshot} />
            </DashboardShell>
        </>
    );
}

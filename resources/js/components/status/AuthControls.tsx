...
export default function AuthControls({ authName, openLogin = false }: AuthControlsProps) {
        ...
        >
            ...
            >
                <div className="flex items-start justify-between gap-3">
                    <div>
                        <h2 id="login-dialog-title" className="text-lg font-semibold tracking-tight">
                            Log In
                        </h2>
                        <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Access the admin panel to manage monitored websites.</p>
                    </div>
                    <button
                        type="button"
                ...
                <form className="mt-5 space-y-4" onSubmit={onLogin}>
                    <label className="block">
                        <span className="text-xs font-medium tracking-wider text-zinc-500 uppercase">Username</span>
                        <input
                            type="text"
                            name="username"
                            required
                    ...
                    <label className="block">
                        <span className="text-xs font-medium tracking-wider text-zinc-500 uppercase">Password</span>

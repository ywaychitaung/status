    ...
    return (
        <div className="mx-auto w-full max-w-3xl space-y-6">
            ...
            <section className="rounded-2xl border border-zinc-200/90 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900/80">
                ...
                <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">Update your display name and username.</p>
                <form method="post" action="/account" className="mt-4 grid gap-3 sm:grid-cols-2">
